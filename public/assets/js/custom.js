                ...
                $nivo_lightbox.nivoLightbox({
                    ...
                    afterShowLightbox: function(){
                        ...
                        if( $nivo_iframe.length > 0 ) {
                            ...
                            $nivo_iframe.attr('src', src + '?autoplay=1&rel=0');
                        }
                    }
                });
            }
    ...
    THEMEMASCOT.slider = {
        ...
        TM_owlCarousel: function() {
            ...
            if ( $owl_carousel_1col.length > 0 ) {
			 ...
			 var $owl_carousel_1col = $('.owl-carousel-1col1, .text-carousel, .image-carousel, .fullwidth-carousel');
            if ( $owl_carousel_1col.length > 0 ) {
                if(!$owl_carousel_1col.hasClass("owl-carousel")){
                    $owl_carousel_1col.addClass("owl-carousel owl-theme");
                }
           ...
           var $recent_works1 = $('.recent_works1');
            if ( $recent_works1.length > 0 ) {
                if(!$recent_works1.hasClass("owl-carousel")){
                    $recent_works1.addClass("owl-carousel owl-theme");
                }
                $recent_works1.each(function() {
                    var data_dots = ( $(this).data("dots") === undefined ) ? false: $(this).data("dots");
                    var data_nav = ( $(this).data("nav")=== undefined ) ? false: $(this).data("nav");
                    var data_duration = ( $(this).data("duration") === undefined ) ? 4000: $(this).data("duration");
                    $(this).owlCarousel({
